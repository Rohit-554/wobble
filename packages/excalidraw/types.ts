...
export interface ExcalidrawProps {
  ...
  /**
   * Called when the user adds a new Google Font or uploads a custom font
   * via the font picker.  Use this to persist the font entry so it can be
   * re-registered on the next page load.
   */
  onCustomFontAdded?: (
    entry: import("./fonts/customFonts").CustomFontEntry,
  ) => void;
}
